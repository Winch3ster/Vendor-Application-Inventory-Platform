...
public class CityField
{
    ...
    [StringLength(100, MinimumLength = 10, ErrorMessage = "Address Line 1 must be at least 10 characters up to 100 characters.")]
    public string? Address1 { get; set; }
    
    [StringLength(100, MinimumLength = 10, ErrorMessage = "Address Line 2 must be at least 10 characters up to 100 characters.")]
